      ...
      <div className="container mx-auto px-4">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
          ...
          <div className="lg:w-7/12" data-aos="fade-right">
            <p className="text-lg text-gray-600 leading-relaxed mb-6 text-justify lg:text-left">
          ...
          <div className="lg:w-5/12 text-center" data-aos="fade-left">
            <div className="bg-gray-50 p-8 rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
              ...
              />
              <h4 className="text-xl font-bold text-dark mb-4 border-b pb-2 border-gray-200 inline-block">Education</h4>
              
              <ul className="space-y-6">
                <li className="relative pl-4">
                  <div className="font-bold text-lg text-dark">Universitas Pembangunan Nasional "Veteran" Jakarta</div>
                  <div className="text-primary font-medium">Informatics (2022 - Present)</div>
                  <div className="text-gray-500 text-sm mt-1 bg-white inline-block px-3 py-1 rounded-full border border-gray-200">GPA: 3.91/4.00</div>
                </li>
                <li className="relative pl-4">
                  <div className="font-bold text-lg text-dark">SMA Negeri 13 Jakarta</div>
                  <div className="text-gray-500">Science (2019 - 2022)</div>
                </li>
              </ul>
            </div>
          </div>
