  ...
  return (
    <section id="skills" className="py-24 bg-white overflow-hidden">
      <div className="container mx-auto px-4 mb-12">
        <h2 className="text-3xl md:text-4xl font-bold text-center text-dark mb-4" data-aos="fade-down">
          Technical Skills
        </h2>
        <div className="w-20 h-1 bg-primary mx-auto rounded-full mb-8" data-aos="fade-down" data-aos-delay="100"></div>
        <p className="text-center text-gray-500 max-w-2xl mx-auto" data-aos="fade-up">
      ...
      <div className="py-10" data-aos="zoom-in">
        <Marquee gradient={true} gradientColor="white" speed={50} pauseOnHover={true}>
          {skillsData.map((skill, index) => (
            <div 
              key={index} 
              className="mx-8 flex flex-col items-center justify-center group cursor-pointer p-4 hover:bg-gray-50 rounded-xl transition-colors"
            >
