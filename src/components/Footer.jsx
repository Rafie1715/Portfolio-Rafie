...
const Footer = () => {
  ...
  const socialLinks = [
    ...
    { icon: "fab fa-instagram", url: "https://instagram.com/rafie_rojagat", color: "hover:text-[#E4405F]" },
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
            ...
            <div className="flex flex-col items-center md:items-start space-y-4">
                <Link to="/" className="text-2xl font-bold text-dark dark:text-white tracking-tighter">
            ...
            <div className="flex flex-col items-center md:items-end space-y-4">
                ...
                <div className="flex gap-4">
                    {socialLinks.map((social, idx) => (
                        <a 
                            ...
                            target="_blank" 
                            rel="noreferrer"
                            className={`w-10 h-10 rounded-full bg-gray-100 dark:bg-slate-800 flex items-center justify-center text-gray-500 dark:text-gray-400 transition-all duration-300 hover:scale-110 shadow-sm ${social.color}`}
                        >
                ...
                <a 
                    ...
                    className="text-xs font-bold px-4 py-2 rounded-lg bg-gray-100 dark:bg-slate-800 text-gray-600 dark:text-gray-300 hover:bg-primary hover:text-white transition-all flex items-center gap-2"
                >
        ...
        <div className="pt-8 border-t border-gray-200 dark:border-slate-800 flex flex-col md:flex-row items-center justify-between gap-4 text-xs text-gray-400">
